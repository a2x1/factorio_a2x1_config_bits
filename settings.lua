...
__settings_startup__data_raw_assembling_machine(data, 3)
__settings_startup__data_raw_furnace(data, 4)
__settings_startup__data_raw_mining(data, 5)
__settings_startup__data_raw_inserter(data, 6)
__settings_startup__data_raw_lab(data, 6)

__settings_global__game_surfaces_always_day(data, 1)
__settings_global__player_force_manual_crafting_speed(data, 3)
__settings_global__player_character(data, 2)
__settings_global__player_force(data, 2)
